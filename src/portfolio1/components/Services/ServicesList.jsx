const services = [
    { icon: InstallationIcon, name: 'App development', desc: 'Offering hardware and software App development (Operating Systems), applications, games, and network infrastructure.' },
    ...
    { icon: DesignIcon, name: 'UI/UXDesign', desc: 'Creating website or app designs & prototypes, brand logos, product designs, mockups, advertisements and more.' },
    ...
    { icon: InstallationIcon, name: 'App development', desc: 'Offering hardware and software App development (Operating Systems), applications, games, and network infrastructure.' },
    { icon: WebDevIcon, name: 'Web Development', desc: 'Crafting personalized portfolio websites, institutional sites, online stores (E-commerce), academic projects, and more.' },
    { icon: DesignIcon, name: 'Graphics Design', desc: 'Creating website or app designs & prototypes, brand logos, product designs, mockups, advertisements and more.' },
    { icon: AutomationIcon, name: 'Automation', desc: 'Providing Telegram & WhatsApp BOT services to enhance online business services, scraping data, and more.' },
]
