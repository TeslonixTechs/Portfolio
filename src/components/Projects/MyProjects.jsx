...
const projects = [
    ...
    },
    {
        ...
        description: "Convo Connect is a user-friendly, feature-rich messaging app designed for individuals and groups. It aims to provide a seamless communication experience, prioritizing simplicity, security and convenience.",
    ...
    },
    {
        ...
        title: 'Camera App',
        image: reactOpenai,
        stacks: 'Flutter and Dart',
        description: "Android and IOS camera app utilizing flutter providing users with an intuitive interface for capturing, editing and sharing photos and videos",
